...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so mis_4480_hw3 can be imported
    ├── src                <- Source code for use in this project.
    │   ├── mis_4480_hw3 <- Main package folder
    │   │   └── __init__.py    <- Marks as package
    │   │   └── mis_4480_hw3.py  <- Just some placeholder Python source code file
    │
